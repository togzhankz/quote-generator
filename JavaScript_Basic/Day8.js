// 151. Write a JavaScript program to run a function in a separate thread by using a Web Worker, allowing long running functions to not block the UI. 
...
// 155. Write a JavaScript program that takes a predicate and array, like Array.filter(), but only keeps x if pred(x) returns false. 
...
// 167. Write a JavaScript program to calculate how many numbers in the given array are less or equal to the given value using the percentile formula. 
...
// 174. Write a JavaScript program to convert a NodeList to an array. 
...
// 185. Write a JavaScript program that will return true if the specified value is undefined, false otherwise. 
...
// 189. Write a JavaScript program that will return true if an object looks like a Promise, false otherwise. 
...
// 199. Write a JavaScript program that will return true if the given number is even, false otherwise. 
...
// 201. Write a JavaScript program to check if the first numeric argument is divisible by the second one. 
