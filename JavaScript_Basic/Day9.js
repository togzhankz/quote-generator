...
// 222. Write a JavaScript program that initializes an array containing the numbers in the specified range where start and end are inclusive and the ratio between two terms is step. Returns an error if step equals 1. 
...
// 246. Write a JavaScript program to convert an given angle from degrees to radians. 
...
// 259. Write a JavaScript program to decode a string of data which has been encoded using base-64 encoding. 



// 260. Write a JavaScript program to evaluate the binomial coefficient of two integers n and k. 



// 261. Write a JavaScript program that will return true if the bottom of the page is visible, false otherwise. 
